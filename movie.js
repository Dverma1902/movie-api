const content=document.querySelector('.content');       //for displaying the movie list
        ...
        searchBtn.addEventListener('click',async()=>{
            ...
            for(let movie of movies){
                ...
                <div class="content-box">
                    ...
                    <div class="center-part">
                        <p>ID : ${id}</p>
                        <p id="rating">Rating: ${rating || 'N/A'}/10</p>
            ...
            favButton.addEventListener('click', () => {
               ...
               // for checking the existence of fav-movie in favMovies array
                const exists=false;
            ...
            favHeader.addEventListener('click', () => {
                ...
                content.style.display = "none";
                 ...
                 if (favMovies.length === 0) {
                       favSection.innerHTML = "<h2>No Favourite Movies Yet!</h2>";
                       return;
                }
                     ...
                     favCard.innerHTML = `
                             ...
                             <div class="content-box">
                              <div class="upper">
                                ...
                                <div class="center-part">
                                    <p>ID : ${movie.id}</p>
                                    <p id="rating">Rating: ${movie.rating || 'N/A'}/10</p>
                                </div>
                            </div>
                            <div class="lower">
